...
{
    [Theory]
    [InlineData(WhatlangLanguage.Ron, Constants.PHRASE_ENG_1, 0.999)]
    [InlineData(WhatlangLanguage.Ukr, Constants.PHRASE_UKR_1, 0.999)]
    [InlineData(WhatlangLanguage.Rus, Constants.PHRASE_RUS_1, 0.999)]
